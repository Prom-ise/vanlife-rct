...
const Dashboard = () => {
  return (
    ...
    <div style={{ padding: "2% 0% 0% 0%", backgroundColor: "#ffead0" }}>
        ...
        <div  className='explore fw-bold'>
            Welcome
        </div>
        <div className='last-income mt-3 mb-4'>
            <div className='flex gap-1'>
         Income last <span style={{textDecoration:"underline", fontWeight:"700"}}><NavLink to='/income' className='last-income'> 30 days </NavLink> </span>
        </div>
        <div style={{color: "#161616"}}>Details</div>
        </div>
        <div  className='explore fw-bold mt-3'>
        $2,260
        </div>
</div>
        <div style={{padding: "2% 10% 3% 8%", backgroundColor: "#ffddb2", display: "flex", justifyContent: "space-between"}}>
            ...
            <div style={{color: "#161616", fontSize: "19px", fontWeight: "500"}}>Details</div>
        </div>

        <div style={{padding: "2% 10% 4% 8%", backgroundColor: "#fff7ed"}}>
        <div className='vansList' >
            <div className='listed-vans'>Your listed vans</div>
            <div><NavLink style={{color: "#161616", fontSize: "19px", fontWeight: "500", textDecoration: "none"}} to="/Vans">View All</NavLink></div>
        </div>
        <div className='vans-list-contain row'>
            <div className='vans-list-container mt-4 col-lg-12 col-md-12 col-12'>
                ...
                <div className='det' style={{color: "#161616", fontSize: "19px", fontWeight: "500"}}>Edit</div>
            </div>
